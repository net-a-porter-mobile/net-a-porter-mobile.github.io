...
GameManager.prototype.pollHighScores = function(){
  var self = this;
...
/*  var self = this;
  ...
  .then(function(data){
    ...
    self.actuator.highscoreSubmitted(true);
  })
  .fail(function(error){
...
GameManager.prototype.keepPlaying = function () {
  // Enable arrow keys
  this.inputManager.setStatus(true);
...
GameManager.prototype.isGameTerminated = function () {
  if (this.over || (this.won && !this.keepPlaying)) {
    // Disable arrow keys
    this.inputManager.setStatus(false);
    return true;
  } else {
    // Enable arrow keys
    this.inputManager.setStatus(true);
...
// Get highscore data
GameManager.prototype.getHighScore = function(score, name){
  var self = this;
  
  self.highscoreManager.getHighScore()
  .then(function(data){
    self.highScores = data;
    self.actuator.updateBestScore(data, {'name' : name, 'score' : score});
  })
  .fail(function (error) {
